...
#        print line
        ...
        if ( tmp.count('?') == 0 and tmp.count('.') == 0 and tmp.count('!') == 0 ) or ( ( tmp.count('?') == 1 and tmp.count('!') == 0 and tmp.count('.') == 0 and tmp[-1] == "?")  or ( tmp.count('.') == 1 and tmp.count('!') == 0 and tmp.count('?') == 0 and tmp[-1] == ".") or ( tmp.count('!') == 1 and tmp.count('.') == 0 and tmp.count('?') == 0 and tmp[-1] == "!"  )) :
